...
We can ay that an API work as a middle man just that in this case, it doesn't take any percentage (lol) from the deal.. In a nutshell, an API is that thing that is between two communicating/interactive devices that makes their interaction go seamlessly.
